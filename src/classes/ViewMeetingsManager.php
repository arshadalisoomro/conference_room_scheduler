...
class ViewMeetingsManager {
	...
	function buildTable($db, $userId) {
		...
		echo '<td>' . "<a class='home_page_link'  href='edit_reservation.php?reservation_id=". $row['_id']."&room_id=".$row['room_id']."'>Edit</a>" . '</td>' . "\r\n";
     	        echo '      </tr>' . "\r\n";
